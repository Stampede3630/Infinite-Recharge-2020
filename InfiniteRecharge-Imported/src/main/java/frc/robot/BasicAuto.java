...
public class BasicAuto {
    ...
    public void newPeriodic() { // from 2020
        switch (step) {
            case 0:
                autoTime.reset();
                autoTime.start();
    ...
    public void trajectoryPeriodic() { // definitely nothing
        switch (trajStep) {
            case 0: // setup
    ...
    public void secondTrenchPeriodic() { // nothing
        switch (trajStep) {
            case 0:
                RobotMap.setDriveTalonsBrake();
                RobotMap.resetEncoders();
    ...
    public void sixBallAuto() { // nothing
        switch (trajStep) {
            case 0: // setup
    ...
    public void threeBall() {
        switch (trajStep) {
            ...
            case 1:
                ...
                break;
            case 2:
                TrajectoryContainer.getInstance().trajectoryFollowingThiefAutoPart1.auto();
                break;
        }
    }

    public void thiefAuto() {
        ...
        switch (trajStep) {
            case 0: // SETUP
                ...
                // dont shoot, trajectory start, INTAKE
                RobotMap.AutoBooleans.SHOOT_NOW = false;
                RobotMap.AutoBooleans.TRAJECTORY_DONE = false;
                RobotMap.AutoBooleans.INTAKE_NOW = true;
            ...
            case 2: // setup for going back to the thing
            ...
            case 3: // strafe to the thing
                TrajectoryContainer.getInstance().trajectoryFollowingThiefAutoPart2.auto();
            ...
            case 4:
                ...
                /*
                 * Intake is on for 1/4 second, off for 1/4 second. Like R Trigger spam!
                 */
                if (((2 * autoTime.get()) % 1.0) > 0.5) {
                    RobotMap.AutoBooleans.INTAKE_NOW = true;
                } else {
                    RobotMap.AutoBooleans.INTAKE_NOW = false;
                }
                ...
                System.out.println("SHOULD BE LINING UP AND SHOOTING =============================");
