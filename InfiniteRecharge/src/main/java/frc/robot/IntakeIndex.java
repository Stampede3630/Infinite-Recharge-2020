...
public class IntakeIndex {
    ...
    public void updateBooleans() {
        ...
        if (RobotMap.IntakeMap.COLOR_SENSOR_HIGH.getGreen() > threshold) {
            top = true;
        }

        if (RobotMap.IntakeMap.COLOR_SENSOR_MID.getGreen() > threshold) {
            middle = true;
        }
        ...
        if (RobotMap.IntakeMap.COLOR_SENSOR_MID.getGreen() > thresholdWeak) {
            middleWeak = true;
        }
    }
