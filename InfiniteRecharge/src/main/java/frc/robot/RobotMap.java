...
public class RobotMap {
    ...
    public static final double FRONT_LEFT_ANGLE_OFFSET = 0.03;
    ...
    public static final double FRONT_RIGHT_ANGLE_OFFSET = 1.7 -.03;
    ...
    public static final double BACK_LEFT_ANGLE_OFFSET = 2.7;
    ...
    public static final double BACK_RIGHT_ANGLE_OFFSET = -2.5;
