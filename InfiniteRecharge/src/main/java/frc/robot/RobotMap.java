...
public class RobotMap {
    ...
    public static final double FRONT_LEFT_ANGLE_OFFSET = 0.03-0.22;
    ...
    public static final double FRONT_RIGHT_ANGLE_OFFSET = 1.7 -.03+0.93;
    ...
    public static final double BACK_LEFT_ANGLE_OFFSET = 2.7-3.07;
    ...
    public static final double BACK_RIGHT_ANGLE_OFFSET = -2.5+.88;
